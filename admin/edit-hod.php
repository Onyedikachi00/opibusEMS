...
if(isset($_POST['update'])){
  ...
  $query = mysqli_query($con, "UPDATE hodtable SET UserName = '$username', Name = '$fname', MobileNumber = '$mobileno', Email = '$email', Position='$position', Address = '$address', Gender = '$gend', MaritalS = '$marstats', DoB = '$dob', NoK = '$nok', NoKphone = '$nokphone' WHERE ID = '$hodid'");
...
<?php 
$hdid=intval($_GET['hdid']);
$query=mysqli_query($con,"select * from hodtable where ID='$hdid'");
$cnt=1;
