...
<head>
  ...
  <title>Opibus Management System  | Department Details</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right" style="color:black;">
              ...
              <li class="breadcrumb"><a href="manage-department.php">Departments</a> &#160; / &#160;</li>
        ...
        <div class="row">
          ...
          <div class="col-md-10 mx-auto">
            <div class="card">
              <?php 
                $did=intval($_GET['deptid']);
                $query=mysqli_query($con,"select * from department where ID='$did'");
                $cnt=1;
                while($result=mysqli_fetch_array($query)){                
              ?>
              <div class="card-header">
                <h4 class="text-center"> <?php echo $result['deptName']."'s Details"?></h4>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="text-center"> <?php echo $result['deptName']."'s Staff"?></h4>
              </div>
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                  ...
                  <?php
                    $displayName = $result['deptName'];
                    $query = mysqli_query($con, "SELECT * FROM stafftable WHERE department='$displayName'");
                    $cnt=1;
                    while($result=mysqli_fetch_array($query)){
                    ?>
                    <tr>
                      ...
                      <th>
                        <a href="edit-staff.php?stfid=<?php echo $result['ID'];?>" title="Edit Sub Admin Details"> <i class="fa fa-edit" aria-hidden="true"></i> </a> |
                        ...
                        <a href="reset-staff-pwd.php?stfid=<?php echo $result['ID']; ?>" title="Reset Sub Admin Password"> <i class="fa fa-key" aria-hidden="true"></i></a>
                      </th>
                    </tr>
                    <?php $cnt++; } ?>
                  </tbody>
