              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>Links</th>
                      <td><a class="btn" style="background-color:coral; color:#fff;" href="admin_stafflatearrivalrequest.php?ltreqid=<?php echo $result['ID'];?>">Late Requests</a></td>
                      <td><a class="btn" style="background-color:coral; color:#fff;" href="admin_staffleaverequests.php?lvreqid=<?php echo $result['ID'];?>">Leave Requests</a></td>
                      <td><a class="btn" style="background-color:coral; color:#fff;" href="admin_stafftemporaryexitrequests.php?txreqid=<?php echo $result['ID'];?>" >Exit Requests</a></td>
                    </tr>
                    <!-- <tr>
                      <th>Other Links</th>
                      <td><a class="btn" style="background-color:coral; color:#fff;" href="staff-details.php?stfid=<?php echo $result['ID'];?>">Payroll</a></td>
                      <td></td>
                    </tr> -->
                  </tbody>     
                </table>                
