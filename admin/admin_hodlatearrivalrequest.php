...
<html lang="en">
  <?php 
    $laterqid=intval($_GET['ltreqid']);
    $query=mysqli_query($con,"select * from hodtable where ID='$laterqid'");
    $getUserQuery = mysqli_query($con, "SELECT Name, Email, MobileNumber, UserType, department FROM hodtable WHERE ID = '$laterqid'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $hodName."'s"?> Late Arrival Requests</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                  <a class="btn btn-primary" style=" color:#fff;" href="admin_hodlatearrivaldetails.php?ltreqid=<?php echo $result['ID'];?>"title="View Details">Details</a>
