...
header('location:index.php');
    ...
    $getUserQuery = mysqli_query($con, "SELECT Name FROM admintable WHERE ID = '$subadminid'");
    ...
    if (isset($_POST['submit'])) {
        ...
        $statid= mysqli_real_escape_string($con,$_POST['status']);
        ...
        $query = mysqli_query($con, "INSERT INTO tblmessages (MailType, Subject, SentBy, Name, UserType, MailContent, filename, status) VALUES ('$mtype', '$subj', '$uname', '$fname', '$utype', '$mcontent' , '$fileNamesString', '$statid')");
                                    ...
                                    <div class="tab-content no-padding" id="myTab2Content">
                                            ...
                                            <form name="subadmin" method="post" enctype="multipart/form-data">
                                                <div class="form-group mb-3" style="display: flex; justify-content: space-between;">
                                                    ...
                                                    <select class="form-control select2-multiple inline" style=" width:40%;" name="fname" id="fname">
                                                        <option value="" style="font-size:15px;">Select Admin/ HR Officer</option>
                                                        <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea style="height: 250px;" class="form-control" id="mailcontent" name="mailcontent" required></textarea>
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="tab-pane fade" id="profile4" role="tabpanel" aria-labelledby="profile-tab4">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    <label for="exampleInputUserType">Status</label>
                                                    <input type="number" class="form-control" id="status" name="status" value="0" required readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputMail">Mail</label>
                                                    <textarea style="height: 250px;" class="form-control" id="mailcontent" name="mailcontent" required></textarea>
