...
<head>
  ...
  <title>Opibus Management System  | Contact us</title>
...
<label for="exampleInputFullname">Mobile Number</label>
 <input type="text" class="form-control" name="mobnum" value="<?php  echo $row['MobileNumber'];?>" required='true' pattern='[0-9]+'>
</div>
