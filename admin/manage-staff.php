              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">         
                  <ol class="float-right">
                    <a href="add-staff.php" class="btn" style=" padding:8px; color:white; background-color:black; border-radius:5px; font-weight:bolder;">+ Add Account</a>
                  </ol>
                </div>
              </div>
            </div>
                          ...
                          <table id="" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a class="btn" style="background-color:black; color:#fff;" href="admin-details.php?said=<?php echo $result['ID'];?>"title="View Details" class=" ">Details</a></td>
                                <td>
                                  <a href="edit-subadmin.php?said=<?php echo $result['ID'];?>" title="Edit Sub HR Officer Details"> <i class="fa fa-edit" aria-hidden="true"></i> </a>
                                  ...
                                  <a href="reset-subadmin-pwd.php?said=<?php echo $result['ID']; ?>" title="Reset Sub HR Officer Password"> <i class="fa fa-key" aria-hidden="true"></i></a>
                                </td>
                              </tr>
                              <?php $cnt++; } ?>
                            </tbody>
