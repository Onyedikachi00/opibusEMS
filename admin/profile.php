...
if(isset($_POST['update'])){
  ...
  $query = mysqli_query($con, "UPDATE admintable SET UserName = '$username', Name = '$fname', MobileNumber = '$mobileno', Email = '$email', Address = '$address', Gender = '$gend', MaritalS = '$marstats', DoB = '$dob', NoK = '$nok', NoKphone = '$nokphone' WHERE ID = '$adminid'");
...
<?php include_once("includes/navbar.php");?>
 ...
 <?php include_once("includes/sidebar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <?php 
    $adminid=intval($_SESSION['aid']);
    $query=mysqli_query($con,"select * from admintable where  ID='$adminid'");
    $cnt=1;
