...
$queryadminName = mysqli_query($con, "SELECT Name FROM admintable WHERE ID = $adminId");
$rowadminName = mysqli_fetch_assoc($queryadminName);
$adminName = $rowadminName['Name']; 
?>
...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <div class="user-panel mt-2 pb-2 mb-1 d-flex">
            ...
            <div class="info">
                <?php
                $query = mysqli_query($con, "SELECT COUNT(*) as messageCount FROM tblmessages WHERE Name = '$adminName' && status = 0");
            ...
            <div class="info" style="margin:3px 0 0 0;">
                <a href="profile.php" class="d-block" style="color: #000; font-size:20px; margin:2px 10px 0 0;"><?php echo "How's it going " . $adminName . ",😊"; ?></a>
            </div>
        </div>
    </ul>
</nav>
