...
include('../includes/config.php');
  ...
  $queryhodName = mysqli_query($con, "SELECT Name FROM hodtable WHERE ID = $hodid");
  $rowhodName = mysqli_fetch_assoc($queryhodName);
  $hodName = $rowhodName['Name']; 
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <div class="user-panel mt-2 pb-2 mb-1 d-flex">
            ...
            <div class="info">
                <?php
                $query = mysqli_query($con, "SELECT COUNT(*) as messageCount FROM tblmessages WHERE Name = '$hodName' && status = 0");
            ...
            <div class="info" style="margin:3px 0 0 0;">
                <a href="hod-profile.php" class="d-block" style="color: #000; font-size:20px; margin:2px 10px 0 0;"><?php echo "How's it going " . $hodName . ",😊"; ?></a>
            </div>
        </div>
    </ul>
</nav>
