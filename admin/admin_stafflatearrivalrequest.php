  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><?php echo $staffName."'s"?> Late Arrival Requests</h1>
          </div>
          <div class="col-sm-6">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                  <a class="btn" style="background-color:coral; color:#fff;" href="admin_stafflatearrivaldetails.php?ltreqid=<?php echo $result['ID'];?>"title="View Details">Details</a>
