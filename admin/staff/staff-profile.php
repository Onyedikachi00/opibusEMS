...
if(isset($_POST['update'])){
  ...
  $query = mysqli_query($con, "UPDATE stafftable SET UserName = '$username', Name = '$fname', MobileNumber = '$mobileno', Email = '$email', Address = '$address', Gender = '$gend', MaritalS = '$marstats', DoB = '$dob', NoK = '$nok', NoKphone = '$nokphone' WHERE ID ='$staffid'");
  if($query){
    // echo "<script>alert('Profile details updated successfully.');</script>";
    echo "<script type='text/javascript'> document.location = 'staff-profile.php'; </script>";
  } else {
                  ...
                  <div class="row g-3">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="username" id="username" class="form-control" value="<?php echo $result['UserName'];?>" required 
