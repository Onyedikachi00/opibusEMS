...
header('location: ../index.php');
    ...
    $getUserQuery = mysqli_query($con, "SELECT Name FROM stafftable WHERE ID = '$subadminid'");
                                        ...
                                        <div class="tab-pane fade active show" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                            <form name="subadmin" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group" style="display: none;">
                                                    ...
                                                    <textarea style="height: 200px;" class="form-control" id="mailcontent" name="mailcontent" required></textarea>
                                                </div>
                                                <div class="form-group">
