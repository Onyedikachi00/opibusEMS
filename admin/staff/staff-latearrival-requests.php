            ...
            <div class="card">
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $query=mysqli_query($con,"SELECT * FROM tbllaterequest WHERE Name = '$staffName'");
                    $cnt=1;
                    ...
                    <tr>
                      ...
                      <td><a class="btn" style="background-color:firebrick; color:#fff;" href="staff-latearrival-details.php?stfid=<?php echo $result['ID'];?>"title="View Details">Details</a></td>
                    </tr>
                    <?php $cnt++;} ?>
