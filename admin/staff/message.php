...
header('location: ../index.php');
    ...
    $getUserQuery = mysqli_query($con, "SELECT Name, ID FROM stafftable WHERE ID = '$staffid'");
                                    ...
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <form name="subadmin" method="post" enctype="multipart/form-data" id="replyForm" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <textarea style="height: 200px;" class="form-control" id="reply" name="reply" required></textarea>
