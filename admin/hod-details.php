...
<head>
  ...
  <title>Opibus Management System | Admin Details</title>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>Links</th>
                      <td><a class="btn btn-primary" style="color:#fff;" href="admin_hodlatearrivalrequest.php?ltreqid=<?php echo $result['ID'];?>">Late Requests</a></td>
                      <td><a class="btn btn-primary" style="color:#fff;" href="admin_hodleaverequests.php?lvreqid=<?php echo $result['ID'];?>">Leave Requests</a></td>
                      <td><a class="btn btn-primary" style="color:#fff;" href="admin_hodtemporaryexitrequests.php?txreqid=<?php echo $result['ID'];?>">Exit Requests</a></td>
                    </tr>
                    <!-- <tr>
                      <th>Other Links</th>
                      <td><a class="btn btn-primary" style="color:#fff;" href="staff-details.php?hdid=<?php echo $result['ID'];?>"title="View Details">Payroll</a></td>
                    </tr> -->
                  </tbody>     
                </table>                
              </div>
