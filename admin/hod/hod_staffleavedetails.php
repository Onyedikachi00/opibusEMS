...
header('location:index.php');
  ...
  $query = mysqli_query($con, "UPDATE tblleaverequest SET Status ='$status', Comment ='$comnt' WHERE ID ='$leaverqid'");
  }
...
<html lang="en">
  <?php 
    $leaverqid=intval($_GET['lvreqid']);
    $query=mysqli_query($con,"SELECT * FROM tblleaverequest WHERE ID = '$leaverqid'");
    $getUserQuery = mysqli_query($con, "SELECT * FROM tblleaverequest WHERE ID = '$leaverqid'");
              ...
              <div class="card-body">
                ...
                <?php if($result['Status']=='' || $result['Status']=='Pending'):?>
                  <div class="container" style="text-align:center;">
                    <button type="button" class="btn" style="background-color:darkseagreen; font-weight:bold; color:white;" data-toggle="modal" data-target="#myModal">
                      Update Status
                    </button>
                  </td>
                <?php endif;?>               
