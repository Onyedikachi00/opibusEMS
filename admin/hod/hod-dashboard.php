      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-3 ">
            ...
            <?php 
            $queryLate = mysqli_query($con, "SELECT * FROM tbllaterequest WHERE Name = '$hodName'");
            ...
            <a href="hod-latearrival-requests.php" class="btn" style="background-color:firebrick; color:#fff;">More info <i class="fas fa-arrow-circle-right"></i></a>
          ...
          <div class="col-md-3 ">
            ...
            <div class="card" style="background-color: #fff; margin: 10px ; padding: 10px 10px; align-items:center;">
            <?php 
            $queryExit = mysqli_query($con, "SELECT * FROM tbltemporaryexit WHERE Name = '$hodName'");
            ...
            <a href="hod-temporary-exit-requests.php" class="btn" style="background-color:darkorchid; color:#fff;">More info <i class="fas fa-arrow-circle-right"></i></a>
          ...
          <div class="col-md-3 ">
            ...
            <div class="card" style="background-color: #fff; margin: 10px ; padding: 10px 10px; align-items:center;">
            <?php 
            $queryLeave = mysqli_query($con, "SELECT * FROM tblleaverequest WHERE Name = '$hodName'");
            ...
            <a href="hod-leave-requests.php" class="btn" style="background-color: darkseagreen; color: #fff;">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-md-3 ">
            <!-- small box -->
            <div class="card" style="background-color: #fff; margin: 10px ; padding: 10px 10px; align-items:center;">
              <?php $query1=mysqli_query($con,"SELECT ID FROM stafftable WHERE department = '$hodDept'");
              $staffs=mysqli_num_rows($query1);
              ?>
              <p style="font-size: 35.5px; font-weight:bold;"><?php echo $staffs;?></p>
              <p style="font-size: 16px;">Staff</p>
              <a href="hod_manage-staff.php" class="btn" style="background-color:darkcyan; color:#fff;">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
