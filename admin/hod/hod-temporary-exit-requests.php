              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a class="btn" style="background-color:darkorchid; color:#fff;" href="hod-temporary-exit-details.php?hdid=<?php echo $result['ID'];?>"title="View Details">Details</a></td>
                  </tr>
                  <?php $cnt++;} ?>
