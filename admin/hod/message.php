...
header('location: ../index.php');
    ...
    $hodid = $_SESSION['aid'];
    $getUserQuery = mysqli_query($con, "SELECT Name, ID FROM hodtable WHERE ID = '$hodid'");
                                    ...
                                    <div class="tab-content no-padding" id="myTab2Content">
                                        ...
                                        <form name="subadmin" method="post" enctype="multipart/form-data" id="replyForm" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" style="height: 200px;" id="reply" name="reply" required></textarea>
