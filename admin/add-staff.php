        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="manage-staff.php">Accounts</a></li>
                      ...
                      <div class="form-group">
                        ...
                        <p>
                            <select class="form-control" name="usertype" id="usertype"  required>
                                ...
                                <option value="Super Admin" style="color: black; font-weight:bolder;">Super Admin</option>
                                <option value="HR Officer" style="color: black; font-weight:bolder">HR Officer</option>
